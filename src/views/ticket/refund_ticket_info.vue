    ...
    <div class="container">
        <el-form ref="formRef" :rules="rules" :model="form" label-width="140px">
            <el-row style="margin-top: 20px; ">
                <el-col class="send-local" :span="12">退券单信息</el-col>
                <el-col class="send-local" :span="12">退还卡券</el-col>
            </el-row>
            <el-row style="margin-top: 30px; padding-bottom: 100px">
                <el-col :span="12">
                    <el-row>
                        <el-col :span="20">
                            <el-form-item label="退还客户">
                                <el-select
                                    :disabled="Type == 'View'"
                                    v-model="form.UnitId"
                                    filterable
                                ...
                                <span v-if="GoodsDiscount > 0">默认折扣：{{ GoodsDiscount }}%</span>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="20">
                            <el-form-item label="退券单号">
                                <el-input disabled v-model="form.BillCode">
                                </el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="整单折扣" prop="ReturnDiscount">
                                <el-input v-model.number="form.ReturnDiscount" @input="inputSaleDiscount">
                    ...
                    <el-row>
                        <el-col :span="20">
                            <el-form-item label="制单人">
                                <el-input disabled v-model="form.PreparedBy">
                                </el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="20">
                            <el-form-item label="制单时间">
                                <el-input disabled v-model="form.PreparationTime">
                                </el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                                        ...
                                        <el-row>
                                            ...
                                            <el-col :span="5">
                                                <div class="flex-col justify-center sale-detail">
                                                    <p class="sale-detail-time">{{ item.TicketTemplateCode }}</p>
                                                    <p class="sale-detail-title line_ellipsi">{{ item.TicketTemplateTitle }}
                                                    </p>
                                                    <p class="sale-detail-time">原价：{{ item.OrgPrice }}</p>
                                                    <!-- <p class="sale-detail-time line_ellipsi" v-if="item.TicketIndexScope">号段：{{ item.TicketIndexScope }}</p> -->
                                                    <el-popover
                                                        placement="bottom"
                                                        title=""
                                                        :width="200"
                                                        trigger="hover"
                                                        :content="item.TicketIndexScope"
                                                    >
                                                        <template #reference>
                                                            <p class="sale-detail-time line_ellipsi" v-if="item.TicketIndexScope">号段：{{ item.TicketIndexScope }}</p>
                                                        </template>
                                            ...
                                            <el-col :span="4">
                                                <div class="flex-col justify-center items-center sale-detail">
                                                    ...
                                                    <div class="flex-col justify-center items-center goods-sales ">
                                                        <div
                                                            class="goode-sales-number flex-row items-center justify-center">
                                                            <div class="goode-number-add" @click="addNumberBtn(index)">+
                                                            </div>
                                                            <div class="goode-number-value">{{ item.TicketCount }}</div>
                                                            <div class="goode-number-reduce"
                                                                @click="reduceNumberBtn(index)">-</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </el-col>
                                            ...
                                            <el-col :span="2">
                                                <div class="flex-col justify-center items-center sale-detail">
                                                    ...
                                                    <p class="sale-detail-td">{{ item.DiscountedPrice }}</p>
                                                </div>
                                            </el-col>
                                            <el-col :span="3">
                                                <div class="flex-col justify-center items-center sale-detail">
                                            ...
                                            <el-col :span="4">
                                                <el-row>
                                                    <el-col>
                                                        <div v-if="Type != 'View'" class="send-edit"
                                                            @click="editSendBtn(item.TicketTemplateId, index, 'Edit')">
                                                            <img src="/src/assets/imgs/send-edit.png" />
                                                        </div>
                                                        <div v-if="Type != 'View'" class="send-del"
                                                            @click="delSendBtn(index)">
                            ...
                            <div class="totalDetail flex-col justify-center">
                                <el-row>
                                    <el-col :span="6" :offset="2"><text style="font-weight: 600;">折后总额：</text>
                                        <text style="color:#f56c6c;font-weight: 600;">{{ (totalCount).toFixed(2) }}</text>
                                    </el-col>
                    ...
                    <el-col :span="22">
                        <el-form-item label="选择卡券" prop="TicketTemplateId">
                            <el-select
                                ...
                                v-model="TicketForm.TicketTemplateTitle"
                                filterable
                                remote
                                reserve-keyword
                                placeholder="请输入关键字查询"
                                :remote-method="remoteMethodGetTicket"
                                remote-show-suffix
                                :loading="TicketLoading"
                                style="width: 100%"
                            >
                                <el-option v-for="(obj, index) in ticketArr" :key="index"
                                    :label="obj.TicketTemplateCode + '-' + obj.TicketTemplateTitle"
                                    :value="obj.TicketTemplateId">
                                </el-option>
                            </el-select>
                            <!-- <el-select v-model="TicketForm.TicketTemplateTitle" filterable style="width: 100%"
                                placeholder="" @change="changeTicketTemplateId($event, index)">
                                <el-option v-for="(obj, index) in ticketArr" :key="index"
                                    :label="obj.TicketTemplateCode + '-' + obj.TicketTemplateTitle"
                                    :value="obj.TicketTemplateId">
                                </el-option>
                ...
                <el-upload v-model:file-list="fileList" :limit="1" :on-exceed="handleExceed" :on-remove="handleRemove"
                    ...
                    <template #tip>
                        <div class="el-upload__tip">
                            <el-link :underline="false" href="https://zytest15.oss-cn-shanghai.aliyuncs.com/liniu/template/价格本模板.xlsx" style="color: #f56c6c">
                                下载模板</el-link>
                        </div>
                        <div class="el-upload__tip">
                            支持上传excel文件
...
import { GetTicketTemplateById, GetMyValidTicketTemplateList,GetTicketTemplateList } from "@/api/ticket.js";
import { SearchUnites, GetUnit,GetUnitList } from "@/api/index.js";
import { GetTicketBillSale,SaveTicketBillReturn,GetTicketBillReturn} from "@/api/bill.js";
...
const rules = {
    ReturnDiscount: [{ required: true, message: "请输入整单折扣", trigger: "blur" }, { type: 'number', message: '折扣必须为数字' }],
};
//卡券数组
...
form.PreparationTime = new Date().toLocaleDateString() + " " + new Date().toLocaleTimeString();
...
const onSubmit = async () => {
    formRef.value.validate(async (valid) => {
        if (valid) {
            ...
            btnLoading.value = false;
            let res = await SaveTicketBillReturn({
                Bill: Bill
            })
            if (res.Code == 200) {
                common.ClosePageTag("退券单详情");
                ElMessage.success("保存成功");
                store.commit("tags/setPageSaerch", {
                    Search: 1, titlePage: "退券单"
                });
                setTimeout(function () {
                    router.push({
                        path: "/refund_ticket",
...
const calculationTableData = async () => {
    ...
    tickets.forEach(row => {
        ...
        Discount = Number(row.Amt) + Discount;
    })
    ticketsAmount.value = Number(Amount);
    ticketsCount.value = Count;
    totalCount.value = Number(Discount * form.ReturnDiscount / 100);
}
const SaveTicketModalBtn = async () => {
    formTicketRef.value.validate(async (valid) => {
        if (valid) {
            if(TicketForm.TicketIndexScope==""){
                ElMessage.error("请输入券号段");
                return;
            }
            addTicketLoading.value = true;
            if (isEditTicket.value != "Edit") {
                if(TicketForm.TicketTemplateTitle.split('-').length>1){
                    //处理多出来的批次号
                    TicketForm.TicketTemplateTitle=TicketForm.TicketTemplateTitle.split('-')[1]
                }
                tickets.push({
                ...
                if(TicketForm.TicketTemplateTitle.split('-').length>1){
                    //处理多出来的批次号
                    tickets[chooseIdx.value].TicketTemplateTitle = TicketForm.TicketTemplateTitle.split('-')[1];
                }else{
                    tickets[chooseIdx.value].TicketTemplateTitle = TicketForm.TicketTemplateTitle;
                }
                tickets[chooseIdx.value].TicketTemplateCode = TicketForm.TicketTemplateCode;
                ...
                tickets[chooseIdx.value].DiscountedPrice = Number(TicketForm.DiscountedPrice).toFixed(2);
...
const remoteMethodGetTicket = async (query) => {
  if (query) {
    let SearchQuery = "";
    if (query !== "") {
      SearchQuery = query;
    ...
    if (res.Code == 200) {
        ticketArr.value = res.DataMap ? res.DataMap : [];
    }
  } else {
    ticketArr.value = [];
  }
...
const GetUnitByID = async (ID) => {
    ...
    if (res.Code == 200) {
        UnitData.value.push({UnitCode:res.DataMap.UnitCode,UnitName:res.DataMap.UnitName,UnitId:res.DataMap.UnitId})
...
const changeTicketTemplateId = async (key) => {
    ...
    if (res.Code == 200) {
        ...
        TicketForm.DiscountedPrice = (Discount / 100 * TicketForm.OrgPrice).toFixed(2);
...
const GetTicketBillSaleById = async (ID) => {
    ...
    if (res.Code == 200) {
        ...
        form.ReturnDiscount = res.DataMap.SaleDiscount;
        ...
        res.DataMap.Details.forEach(row => {
            tickets.push({
                ...
                DiscountedPrice: Number(row.Amt / row.TicketCount / 100).toFixed(2),//折后价
                TicketIndexScope: row.TicketIndexScope,
            });
        })
        calculationTableData()
...
const addTicketBtn = async (val) => {
    ...
    TicketForm.Discount = GoodsDiscount.value?GoodsDiscount.value:100;
};
...
const inputSaleDiscount = (idx) => {
    if (idx < 0) {
        form.ReturnDiscount = 0
    }
    calculationTableData()
};
const GetTicketBillReturnApi = async (id) => {
    let res = await GetTicketBillReturn({
        ObjectId: id,
    })
    if (res.Code == 200) {
        form.BillCode = res.DataMap.BillCode;
        form.UnitId = res.DataMap.UnitId=="0"?"":res.DataMap.UnitId;
        if(form.UnitId>0){
            changeCustomer(form.UnitId)
        }
        form.TicketCount = res.DataMap.TicketCount;
        form.ReturnDiscount = res.DataMap.ReturnDiscount;
        form.SaleAmt = res.DataMap.SaleAmt;
        form.BillConfig = res.DataMap.BillConfig;
        form.BillRemark = res.DataMap.BillRemark;
        form.PreparedBy = res.DataMap.CreateUserName;
