<template>
  <div class="container">
    ...
    >
      ...
      <el-table-column align="center" label="SKU编码" width="150">
      ...
      <el-table-column align="center" label="线上库存">
        <template #default="scope">
          <p v-if="scope.row.TotalQty > 0">{{ scope.row.TotalQty }}</p>
        </template>
      </el-table-column>
      <el-table-column align="center" label="线下库存">
        <template #default="scope">
          <p v-if="scope.row.TotalQty2 > 0">{{ scope.row.TotalQty2 }}</p>
        </template>
      </el-table-column>
    </el-table>
...
import { SearchGoodsQtyes } from "@/api/goods.js";
...
const getData = async () => {
  ...
  let res = await SearchGoodsQtyes({
