<template>
    <div class="container">
        ...
        <el-table :data="tableData" border class="table" v-loading="tableLoading" ref="multipleTable"
            ...
            <el-table-column prop="FieldV1" align="center" label="姓名"></el-table-column>
            <el-table-column prop="FieldV2" align="center" label="电话">
            </el-table-column>
            <el-table-column prop="CreateTime" align="center" label="提交时间"></el-table-column>
            <el-table-column prop="BillRemark" align="center" label="备注"></el-table-column>
                ...
                <template #default="scope">
                    <div class="button-mgl">
                        <el-button v-if="scope.row.BillStatus == 0" class="button-op-del" size="small"
                            @click="handleDel(scope.row.BillId)">已联系
                        </el-button>
                    </div>
                </template>
            </el-table-column>
